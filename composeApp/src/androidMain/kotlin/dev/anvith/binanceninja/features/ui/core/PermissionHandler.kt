...
actual class PermissionHandler(
  ...
  private var permissionRequests = mutableMapOf<Int, WeakReference<Pair<() -> Unit, () -> Unit>>>()
  ...
  actual fun requestPermission(
    ...
    if (androidPermission != null) {
      ...
      if (
        ...
        ActivityCompat.requestPermissions(activityContext, arrayOf(androidPermission), requestId)
      } else {
        onGranted()
      }
    } else {
  ...
  private fun PermissionType.asAndroidPermission(): String? =
    when (this) {
