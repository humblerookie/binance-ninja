...
interface TextModifier {
  ...
  @Composable fun applyToText(text: String, modifier: Modifier)

  @Composable fun applyToText(text: AnnotatedString, modifier: Modifier)

  @Composable fun style(): TextStyle
